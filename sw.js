...
self.addEventListener('fetch', e => {
  ...
  // index.html / manifest / ไอคอน: เอาของใหม่ก่อน ถ้าเน็ตล่มค่อยใช้ของเก่า
  // (ไอคอนต้อง network-first ไม่งั้นเปลี่ยนโลโก้แล้วเครื่องเดิมยังเห็นของเก่าตลอด)
  const freshFirst = req.mode === 'navigate'
